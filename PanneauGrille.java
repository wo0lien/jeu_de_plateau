...
class PanneauGrille extends JPanel {
	...
	private BufferedImage feca;
	private BufferedImage iop;
	...
	public PanneauGrille(Personnage[] p) {
		...
		try {
			...
			feca = ImageIO.read(new File("feca.png"));
			trees = ImageIO.read(new File("map_trees.png"));
			iop = ImageIO.read(new File("iop.png"));
		} catch (IOException e) {}
